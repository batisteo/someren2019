...
(function( $ ){
	...
	$('#mu-event-counter').countdown('2019/07/13 18:00:00').on('update.countdown', function(event) {
	  var $this = $(this).html(event.strftime(''
	    + '<span class="mu-event-counter-block"><span>%D</span> tagoj</span> '
	    + '<span class="mu-event-counter-block"><span>%H</span> horoj</span> '
	    + '<span class="mu-event-counter-block"><span>%M</span> minutoj</span> '
	    + '<span class="mu-event-counter-block"><span>%S</span> sekundoj</span>'));
	});
